/*jslint indent: 2 */
/*global sinon, module, test, ok, strictEqual, notStrictEqual, stop, start,
  setTimeout, promy */
...
(function () {
  ...
  var fulfilled = promy.fulfilled;
  var rejected = promy.rejected;
  var pending = promy.pending;
  ...
  function describe(string, subFunction) {
    test(string, 0, emptyFunction);
    subFunction();
  }
  ...
  describe("3.2.2: If `onFulfilled` is a function,", function () {
    describe("3.2.2.1: it must be called after `promise` is fulfilled, with `promise`’s fulfillment value as its first argument.", function () {
  ...
  describe("3.2.3: If `onRejected` is a function,", function () {
    describe("3.2.3.1: it must be called after `promise` is rejected, with `promise`’s rejection reason as its first argument.", function () {
  ...
  describe("3.2.5: `then` may be called multiple times on the same promise.", function () {
    describe("3.2.5.1: If/when `promise` is fulfilled, respective `onFulfilled` callbacks must execute in the order of their originating calls to `then`.", function () {
    ...
    describe("3.2.5.2: If/when `promise` is rejected, respective `onRejected` callbacks must execute in the order of their originating calls to `then`.", function () {
      ...
      describe("`onRejected` handlers are called in the original order", function () {
        testRejected(dummy, function (promise, done) {
          var handler1 = sinon.spy(function handler1() { return; });
          var handler2 = sinon.spy(function handler2() { return; });
          var handler3 = sinon.spy(function handler3() { return; });
  ...
  describe("3.2.6: `then` must return a promise: `promise2 = promise1.then(onFulfilled, onRejected)`", function () {
    ...
    describe("3.2.6.1: If either `onFulfilled` or `onRejected` returns a value that is not a promise, `promise2` must be fulfilled with that value.", function () {
    ...
    describe("3.2.6.2: If either `onFulfilled` or `onRejected` throws an exception, `promise2` must be rejected with the thrown exception as the reason.", function () {
      ...
      testReason({then: function () { return; }}, "a promise-alike");
      testReason(fulfilled(dummy), "a fulfilled promise");
      testReason(rejected(dummy), "a rejected promise");
    });

    describe("3.2.6.3: If either `onFulfilled` or `onRejected` returns a promise (call it `returnedPromise`), `promise2` must assume the state of `returnedPromise`", function () {
      describe("3.2.6.3.1: If `returnedPromise` is pending, `promise2` must remain pending until `returnedPromise` is fulfilled or rejected.", function () {
        testFulfilled(dummy, function (promise1, done) {
      ...
      describe("3.2.6.3.2: If/when `returnedPromise` is fulfilled, `promise2` must be fulfilled with the same value.", function () {
      ...
      describe("3.2.6.3.3: If/when `returnedPromise` is rejected, `promise2` must be rejected with the same reason.", function () {
        describe("`promise1` is fulfilled, and `returnedPromise` is:", function () {
    ...
    describe("3.2.6.4: If `onFulfilled` is not a function and `promise1` is fulfilled, `promise2` must be fulfilled with the same value.", function () {
    ...
    describe("3.2.6.5: If `onRejected` is not a function and `promise1` is rejected, `promise2` must be rejected with the same reason.", function () {
